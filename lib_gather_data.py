...
from pandas_helper import get_list_of_index_names, broadcast_simple, load_input_data
...
def gather_capital_data(root_dir_, include_legacy_sids=False, plot_coverage_map=False):
