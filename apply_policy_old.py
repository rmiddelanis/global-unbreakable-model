...
def apply_policy_old(macro_, cat_info_, hazard_ratios_, event_level, policy_name=None, policy_opt=None, verbose=True):
    """
    ...
    # Pov reduction
        ...
        # TODO: description says income, but doesn't this increase capital?!
    ...
    # Exposure equals to nonpoor exposure (mind that exposure in cat_info is OVERWRITTEN by exposure in hazard_ratios)
        ...
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "borrowing_abibility")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "prepare_scaleup")

        desc = "Postdisaster\nsupport\npackage"

    elif policy_name == "ResiliencePackage":
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "PDSpackage")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "axfin")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "T_rebuild_K")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "social_p")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "prop_nonpoor_lms")
        desc = "Resilience package"


    elif policy_name == "ResiliencePlusEW":
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "ResiliencePackage")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "shew")

        desc = "Resilience Package + Early Warning Package"

    elif policy_name == "Asset_losses":
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "fap")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "far")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "vp")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "vr")
        macro, cat_info, hazard_ratios, desc = apply_policy_old(macro, cat_info, hazard_ratios, event_level, "shew")
