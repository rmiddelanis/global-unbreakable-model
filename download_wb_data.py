...
print("in the ", x.shape[0], "countries where ASPIRE reports data, poor people receive only",
      100 * (4 * x.q1 * x.popu).sum() / ((x.q2 + x.q3 + x.q4 + x.q5) * x.popu).sum(),
      "percent of what nonpoor people receive from public and private transfers")
